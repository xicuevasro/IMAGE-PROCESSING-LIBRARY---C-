...
template<typename T>
void directFFT1DX(const v2_0::Image<T>& realIn, const v2_0::Image<T>& imagIn, v2_0::Image<T>& realOut, v2_0::Image<T>& imagOut);

template<typename T>
void directFFT1DY(const v2_0::Image<T>& realIn, const v2_0::Image<T>& imagIn, v2_0::Image<T>& realOut, v2_0::Image<T>& imagOut);

template<typename T>
void inverseFFT(const v2_0::Image<T>& realIn, const v2_0::Image<T>& imagIn, v2_0::Image<T>& realOut, v2_0::Image<T>& imagOut);

template<typename T>
void inverseFFT1DX(const v2_0::Image<T>& realIn, const v2_0::Image<T>& imagIn, v2_0::Image<T>& realOut, v2_0::Image<T>& imagOut);

template<typename T>
void inverseFFT1DY(const v2_0::Image<T>& realIn, const v2_0::Image<T>& imagIn, v2_0::Image<T>& realOut, v2_0::Image<T>& imagOut);
...
// 1D spectrum along X dimension
template<typename T>
void directFFT1DX(const v2_0::Image<T>& realIn, const v2_0::Image<T>& imagIn, v2_0::Image<T>& realOut, v2_0::Image<T>& imagOut)
{
	int NN[2] = { 0, realIn.getWidth() };
	int dim = NN[1], n = 1;
	...
	for (int j{ 0 }; j < realIn.getHeight(); ++j)
	{
		...
		for (int i{ 0 }; i < NN[1]; ++i)
		{
			int i0 = (i + NN[1] / 2) % NN[1];
			realOut(i0, j) = static_cast<T>(tmp[2 * i + 1] / dim);
			imagOut(i0, j) = static_cast<T>(tmp[2 * i + 2] / dim);
		}
	}
...
// 1D spectrum along Y dimension
template<typename T>
void directFFT1DY(const v2_0::Image<T>& realIn, const v2_0::Image<T>& imagIn, v2_0::Image<T>& realOut, v2_0::Image<T>& imagOut)
{
	int NN[2] = { 0, realIn.getHeight() };
	int dim = NN[1], n = 1;
	...
	for (int i{ 0 }; i < realIn.getWidth(); ++i)
	{
		...
		{
			int j0 = (j + NN[1] / 2) % NN[1];
			realOut(i, j0) = static_cast<T>(tmp[2 * j + 1] / dim);
			imagOut(i, j0) = static_cast<T>(tmp[2 * j + 2] / dim);
		}
	}
...
void inverseFFT1DX(const v2_0::Image<T>& realIn, const v2_0::Image<T>& imagIn, v2_0::Image<T>& realOut, v2_0::Image<T>& imagOut)
{
	...
	for (int j{ 0 }; j < realIn.getHeight(); ++j)
	{
		...
		{
			int i0 = (i + NN[1] / 2) % NN[1];
			tmp[2 * i + 1] = realIn(i0, j);
			tmp[2 * i + 2] = imagIn(i0, j);
		}
...
void inverseFFT1DY(const v2_0::Image<T>& realIn, const v2_0::Image<T>& imagIn, v2_0::Image<T>& realOut, v2_0::Image<T>& imagOut)
{
	...
	for (int i{ 0 }; i < realIn.getWidth(); ++i)
	{
		...
		{
			int j0 = (j + NN[1] / 2) % NN[1];
			tmp[2 * j + 1] = realIn(i, j0);
			tmp[2 * j + 2] = imagOut(i, j0);
		}
